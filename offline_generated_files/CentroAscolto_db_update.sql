...
ALTER TABLE `ResidenzaInAlloggio` 
  CHANGE `tipologia_alloggio` `tipologia_alloggio` int(10),
  CHANGE `classe_alloggio` `classe_alloggio` int(10) NOT NULL,
  CHANGE `dal` `dal` DATE,
  CHANGE `al` `al` DATE,
  CHANGE `descrizione` `descrizione` longtext NOT NULL,
  CHANGE `allegato` `allegato` int(10),
...
CREATE TABLE `Spesa` (
  ...
  ADD`anno` int(10) NOT NULL,
  ADD`mese` int(10) NOT NULL,
  ADD`note` longtext,
  ADD`solo_percorsi` double,
  ADD`tipo_di_spesa` varchar(200) NOT NULL,
  ADD`unrra` double,
...
ALTER TABLE `Utente` 
  ...
  CHANGE `area_geografica_provenienza` `area_geografica_provenienza` int(10) NOT NULL,
